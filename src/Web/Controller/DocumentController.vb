...
Public Class DocumentController
    ...
    End Function
    Public Function Document_Get(CustomerUID As Integer) As DataTable
        ds = SqlHelper.ExecuteDataset(ConnectionString, GetFullyQualifiedName("Document_Get"), CustomerUID)
        Return ds.Tables(0)
    End Function
    ...
    Public Function Document_GetStudentBySex(RegYear As String, CustomerID As Integer, Phase As Integer, DegreeNo As Integer, sSex As String, SubjectCode As String) As DataTable
        ds = SqlHelper.ExecuteDataset(ConnectionString, GetFullyQualifiedName("Document_GetStudentBySex"), RegYear, CustomerID, Phase, DegreeNo, sSex, SubjectCode)
    ...
    Public Function Document_GetStudentNoDocument(RegYear As Integer, SubjCode As String, CID As Integer, Optional sKey As String = "") As DataTable
        ...
        Return ds.Tables(0)
    End Function
    Public Function Document_Save(DocumentUID As Integer, CustomerUID As Integer, Desc As String, UpdBy As String) As Integer
        Return SqlHelper.ExecuteNonQuery(ConnectionString, GetFullyQualifiedName("Document_Save"), DocumentUID, CustomerUID, Desc, UpdBy)
    End Function
    Public Function PaymentSlip_Add(DocumentUID As Integer, RequestUID As Integer, CustomerUID As Integer, FilePath As String, Amount As Double, UpdBy As String) As Integer
        Return SqlHelper.ExecuteNonQuery(ConnectionString, GetFullyQualifiedName("PaymentSlip_Add"), DocumentUID, RequestUID, CustomerUID, FilePath, Amount, UpdBy)
    End Function
