...
#Region "Locations"
    ...
    Public Function Location_UpdateNewCode(ByVal LocationUID As Integer, ByVal NewCode As String) As Integer
        Return SqlHelper.ExecuteNonQuery(ConnectionString, "Location_UpdateNewCode", LocationUID, NewCode)
    End Function
