...
#End Region
#Region "SystemConfig"
    Public Function SystemConfig_GetValue(ByVal pid As String) As String
        ds = SqlHelper.ExecuteDataset(ConnectionString, GetFullyQualifiedName("SystemConfig_GetValue"), pid)
        Return DBNull2Str(ds.Tables(0).Rows(0)(0))
    End Function

    Public Function SystemConfig_Add(ByVal pCode As String, ByVal pYear As String, ByVal pNo As String) As Integer
        Return SqlHelper.ExecuteNonQuery(ConnectionString, GetFullyQualifiedName("SystemConfig_Add"), pCode, pYear, pNo)
    End Function

    Public Function SystemConfig_Update(ByVal pCode As String, ByVal pYear As String, ByVal pNo As String) As Integer
        Return SqlHelper.ExecuteNonQuery(ConnectionString, GetFullyQualifiedName("SystemConfig_Update"), pCode, pYear, pNo)
    End Function
...
#Region "Bank"
    ...
    Public Function Bank_CheckDuplicate(Code As String) As Boolean
        ds = SqlHelper.ExecuteDataset(ConnectionString, "Bank_CheckDuplicate", Code)
        If ds.Tables(0).Rows.Count > 0 Then
            If String.Concat(ds.Tables(0).Rows(0)(0)) <> "0" Then
                Return True
            Else
    ...
    Public Function Bank_GetByUID(UID As Integer) As DataTable
        ds = SqlHelper.ExecuteDataset(ConnectionString, "Bank_GetByUID", UID)
        Return ds.Tables(0)
    End Function

    Public Function Bank_Save(BankID As Integer, Code As String, Name As String)
        Return SqlHelper.ExecuteNonQuery(ConnectionString, "Bank_Save", BankID, Code, Name)
    End Function

    Public Function Bank_Delete(ByVal UID As Integer) As Integer
        Return SqlHelper.ExecuteNonQuery(ConnectionString, GetFullyQualifiedName("Bank_Delete"), UID)
    End Function

#End Region

#Region "Bank Account"
    Public Function BankAccount_Get() As DataTable
        ds = SqlHelper.ExecuteDataset(ConnectionString, "BankAccount_Get")
        Return ds.Tables(0)
    End Function

    Public Function BankAccount_CheckDuplicate(AccountNo As String) As Boolean
        ds = SqlHelper.ExecuteDataset(ConnectionString, "BankAccount_CheckDuplicate", AccountNo)
        If ds.Tables(0).Rows.Count > 0 Then
            If String.Concat(ds.Tables(0).Rows(0)(0)) <> "0" Then
                Return True
            Else
    ...
    Public Function BankAccount_GetByAccountNo(AccountNo As String) As DataTable
        ds = SqlHelper.ExecuteDataset(ConnectionString, "BankAccount_GetByAccountNo", AccountNo)
        Return ds.Tables(0)
    End Function

    Public Function BankAccount_Save(AccountNo As String, AccName As String, BankID As Integer, Branch As String)
        Return SqlHelper.ExecuteNonQuery(ConnectionString, "BankAccount_Save", AccountNo, AccName, BankID, Branch)
    End Function

    Public Function BankAccount_Delete(ByVal AccountNo As String) As Integer
        Return SqlHelper.ExecuteNonQuery(ConnectionString, GetFullyQualifiedName("BankAccount_Delete"), AccountNo)
    End Function
...
#Region "Cane"
    ...
    Public Function CaneType_Get() As DataTable
    ...
    Public Function CaneType_GetForReport() As DataTable
        ...
        Return ds.Tables(0)
    End Function
    Public Function CaneType_GetByID(ByVal pid As Integer) As DataTable
        ds = SqlHelper.ExecuteDataset(ConnectionString, GetFullyQualifiedName("CaneType_GetByID"), pid)
        Return ds.Tables(0)
    End Function

    Public Function CaneType_GetName(ByVal pid As Integer) As DataTable
        ds = SqlHelper.ExecuteDataset(ConnectionString, GetFullyQualifiedName("CaneType_GetName"), pid)
        Return ds.Tables(0)
    End Function

    Public Function CaneType_Save(ByVal pid As Integer, name As String, remark As String) As Integer
        Return SqlHelper.ExecuteNonQuery(ConnectionString, GetFullyQualifiedName("CaneType_Save"), pid, name, remark)
    End Function

    Public Function CaneType_Delete(ByVal pid As Integer) As Integer
        Return SqlHelper.ExecuteNonQuery(ConnectionString, GetFullyQualifiedName("CaneType_Delete"), pid)
    End Function
    Public Function CaneType_CheckDuplicate(ByVal name As String) As Integer
        ds = SqlHelper.ExecuteDataset(ConnectionString, GetFullyQualifiedName("CaneType_CheckDuplicate"), name)
