...
Public Class UserController
    ...
    Public Function User_Save(
        ...
        Return SqlHelper.ExecuteNonQuery(ConnectionString, GetFullyQualifiedName("User_Save"), UserID, Username, Passwords, DisplayName, Email, Telephone, RoleID, StatusFlag, CUser)
