...
#Region "Declaration Parameter"
    ...
    Public CustomerReport As String = ConfigurationSettings.AppSettings("CustomerReport")
    Public SlipPay As String = ConfigurationSettings.AppSettings("SlipPay")
    Public SlipRev As String = ConfigurationSettings.AppSettings("SlipRev")
    ...
    'Public DocumentCustomer As String = ConfigurationSettings.AppSettings("DocumentCustomer")
