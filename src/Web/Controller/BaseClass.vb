...
Public Class BaseClass : Inherits ApplicationBaseClass
    ...
    Private sqlSrvDatabase As String = ""
...
#End Region
    ...
    Public Sub CheckSession(ByVal p As Page)
        If (Not (p.Request.Cookies("Kondongpu")("userid")) Is Nothing) Then
            Return
        End If
    ...
    Public Sub CheckGroup(ByVal p As Page, ByVal permission As String)
        If (Not (p.Request.Cookies("Kondongpu")("UserLevel")) Is Nothing) Then
            If permission.Contains(p.Request.Cookies("Kondongpu")("UserLevel").ToString) Then
                Return
            End If
        End If
        p.Request.Cookies("Kondongpu")("ErrorMessage") = "<br />คุณไม่ได้รับสิทธิ์ให้ใช้งานหน้านี้"
        p.Request.Cookies("Kondongpu")("SendToURL") = "default.aspx"
...
#Region "Generate ID"
    Public Function RunningNumber_New(ByVal code As String, Optional iYear As Integer = 0) As String
        ...
        Else
            ...
            Return "ยังไม่ได้กำหนดค่า Running Number"
    ...
    '65-0001
    Public Function RunningNumber2_New(ByVal code As String, Optional iYear As Integer = 0) As String
        Dim dsR As New DataSet
    ...
    End Sub
    Public Sub RunningNumber_Update(ByVal tCode As String)
        SqlHelper.ExecuteNonQuery(ConnectionString, "Running_Update", tCode)
    End Sub
