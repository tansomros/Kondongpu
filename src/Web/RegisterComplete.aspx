<%@ Page Title="" Language="VB" AutoEventWireup="false" CodeBehind="RegisterComplete.aspx.vb" Inherits="KDP.RegisterComplete" %>
                                        ...
                                        <div class="row"> 
                                            <div class="col-lg-12"> 
                                                    ...
                                                    <div class="form-group has-feedback text-center">
                                                        <label>ท่านทำการลงทะเบียนร้านยาเรียบร้อย</label>
                                                         <br /> สามารถตรวจสอบ Username Password สำหรับ Login เข้าสู่ระบบได้ที่อีเมลที่ท่านทำการลงทะเบียนไว้
                                                    </div>                                                   
                                                    <div class="row">
