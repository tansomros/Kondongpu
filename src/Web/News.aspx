<%@ Page Title="News - ข่าวประชาสัมพันธ์" Language="VB" AutoEventWireup="true" CodeBehind="News.aspx.vb" Inherits="KDP.News" %>
                                                ...
                                                <div class="card card-sm card-post h-100">
                                                    <div class="card-media">
                                                        <a target="_blank" href='<% Response.Write(dtNew.Rows(i)("NewsLink")) %>' title='<% Response.Write(dtNew.Rows(i)("NewsHead")) %>' rel="bookmark">
                                                            <img src="<% Response.Write(KDP.ImageCoverNews + dtNew.Rows(i)("CoverimagePath")) %>" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" height="160" width="300" alt="" />
                                                        </a>
                                                    </div>
