<%@ Page Title="" Language="VB" AutoEventWireup="true" CodeBehind="Default.aspx.vb" Inherits="Kondongpu._Default" %>
                                                ...
                                                <div class="p-5">
                                                    <div class="text-center">
                                                        <div class="login-logo">
                                                            <img src="images/kdphead.png" width="100%" />
                                                            <br />
                                                        </div>
                                                    </div>
                ...
                <div class="footer text-center">
                    <footer class="main-footer-login">
                        <div class="text-center hidden-xs">
                            ...
                            <br /> <b>Version</b>
                            <asp:Label ID="Label1" runat="server" Text="1.0.0"></asp:Label>&nbsp;&nbsp;<b>Release</b> 2022.12.01
                        </div>
                    </footer>
                </div>
            </div>
