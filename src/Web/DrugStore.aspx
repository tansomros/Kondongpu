<%@ Page Title="" Language="vb" AutoEventWireup="true"   CodeBehind="DrugStore.aspx.vb" Inherits="KDP.DrugStore" %>
            ...
            <div class="container-login">
                ...
                <div class="row">
                      <section class="col-lg-3 connectedSortable">
                        <div class="menu-box">
                            <div class="box-body">  
                                 <a href="DrugStore.aspx" class="btn btn-menu-main btn-menu btn-block-menu active">
