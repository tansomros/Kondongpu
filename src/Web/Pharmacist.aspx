<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Pharmacist.aspx.vb" Inherits="KDP.Pharmacist" %>
                    ...
                    <div class="col-lg-12">
                        <div class="justify-content-center">
                            ...
                            <div class="row justify-content-center"> 
                                ...
                                <a href="Customer.aspx?m=l" class="btn btn-secondary">กลับหน้ารายการร้านยา</a>
                                <% End If %>
                            </div>
