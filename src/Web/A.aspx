<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="A.aspx.vb" Inherits="Kondongpu.A" %>
                            ...
                            <div class="col-md-12">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="header-logo">ฅนดงพุ (kondongpu)</div>
                        ...
                        <div class="menu-box">
                            <div class="box-body">     
                                 <a href="DrugStore.aspx" class="btn btn-menu-main btn-menu btn-block-menu">
                                    <span class="box-icon-menu"><i class="material-icons icon-menu add_business">&#xe729;</i></span>ตรวจสอบรายชื่อ<br/>Drug Store                             
                                </a>
