Public Class Cane
    ...
    End Sub
    Private Sub LoadCaneToGrid()
        dt = ctlL.CaneType_Get()
        With grdData
            .Visible = True
            .DataSource = dt
            .DataBind()
    ...
    Private Sub grdData_RowCommand(sender As Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grdData.RowCommand
        If TypeOf e.CommandSource Is WebControls.LinkButton Then
            ...
            Select Case ButtonPressed.ID
                ...
                Case "imgDel"
                    If ctlL.CaneType_Delete(e.CommandArgument) Then
                        acc.User_GenLogfile(Request.Cookies("username").Value, ACTTYPE_DEL, "Cane", "ลบชื่อประเภทอ้อย :" & txtName.Text, "")
    ...
    Private Sub EditData(ByVal pID As String)
        dt = ctlL.CaneType_GetByID(pID)
        If dt.Rows.Count > 0 Then
            With dt.Rows(0)
                isAdd = False
                Me.txtUID.Text = String.Concat(dt.Rows(0)("UID"))
                txtName.Text = String.Concat(dt.Rows(0)("CaneName"))
    ...
    Protected Sub cmdSave_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        ...
        If StrNull2Zero(txtUID.Text) = 0 Then
            If ctlL.CaneType_CheckDuplicate(txtName.Text) Then
        ...
        ctlL.CaneType_Save(StrNull2Zero(txtUID.Text), txtName.Text, txtRemark.Text)
        grdData.PageIndex = 0
        LoadCaneToGrid()
        ClearData()
    ...
    Private Sub cmdDelete_Click(sender As Object, e As EventArgs) Handles cmdDelete.Click
        ctlL.CaneType_Delete(StrNull2Zero(txtUID.Text))
        grdData.PageIndex = 0
        LoadCaneToGrid()
    End Sub
