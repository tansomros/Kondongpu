<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Account.aspx.vb" Inherits="Kondongpu.Account" %>
      ...
      <div class="app-page-title">
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        ...
                        <div>ประเภทรายการบัญชี
                            <div class="page-title-subheading">จัดการ เพิ่ม/แก้ไข ประเภทรายการบัญชี </div>
                        </div>
                    </div>
                </div>
            </div> 
        ...
        <div class="modal-content">
          <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <h6 class="modal-title">จัดการรายการบัญชี</h6>
          </div>
