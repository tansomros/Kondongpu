<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ReportAssessment.aspx.vb" Inherits="KDP.ReportAssessment" %>
...
<% If Request("s") = "A2" Then %>
                            ...
                            <tbody>
                               ...
                               <% If Request("s") = "A1" Then %>
                                    ...
                                    <td class="text-center"><% =KDP.StrNull2Double(String.Concat(row("GPP_Score"))) + KDP.StrNull2Double(String.Concat(row("QA_Score"))) %></td>
                                        <% End If %>
                                <% If Request("s") = "A2" Then %>
