<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ReportViewerStudentBio.aspx.vb" Inherits=".ReportViewerStudentBio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <section class="content-header">
      <h1><asp:Label ID="lblReportTitle" runat="server" Text="พิมพ์ประวัตินิสิต"></asp:Label>
          <small></small>
...
<section class="content">
 ...
 <div class="box box-primary">
            <div class="box-header">
              ...
              <h3 class="box-title">พิมพ์ประวัตินิสิต</h3>             
...
<table width="100%" border="0" cellspacing="2" cellpadding="0">
 ...
 <tr>
  ...
  <tr>
    ...
    <tr>
        <td align="center">
         <iframe src="ReportStudentBioView.aspx" height="700" width="100%" frameborder="0" title="พิมพ์ประวัตินิสิต"></iframe>
        </td>
    </tr>
</table>
</div>
