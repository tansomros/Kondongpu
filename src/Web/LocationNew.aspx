<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="LocationNew.aspx.vb" Inherits="KDP.LocationNew" %>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="p-2">
                                        <div class="text-left">
                                            <h3 class="card-title"><b>ลงทะเบียนขอใช้งาน </b></h3>
                                            <br />
                                        </div>
