<%@ Page Title="" Language="vb" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="GPP.aspx.vb" Inherits="KDP.GPP" %>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                             <table class="table no-border">
                                        <tr>
                                            <td style="width:55px;padding-top:10px;"><asp:CheckBox ID="chkS5Q7" runat="server" AutoPostBack="True" Text="ไม่มี" /></td>
                                              <td><asp:RadioButtonList ID="optS5Q7" runat="server"
                                                        RepeatDirection="Horizontal" CssClass="table no-border"  AutoPostBack="True">
                                                       <asp:ListItem Value="0">ปรับปรุง</asp:ListItem>
                                                        <asp:ListItem Value="1"> พอใช้</asp:ListItem>
                                                        <asp:ListItem Value="2">ดี</asp:ListItem>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                              <table class="table no-border">
                                        <tr>
                                            <td style="width:55px;padding-top:10px;"><asp:CheckBox ID="chkS5Q10" runat="server" AutoPostBack="True" Text="ไม่มี" /></td>
                                              <td><asp:RadioButtonList ID="optS5Q10" runat="server"
                                                        RepeatDirection="Horizontal" CssClass="table no-border"  AutoPostBack="True">
                                                       <asp:ListItem Value="0">ปรับปรุง</asp:ListItem>
                                                        <asp:ListItem Value="1"> พอใช้</asp:ListItem>
                                                        <asp:ListItem Value="2">ดี</asp:ListItem>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                              <table class="table no-border">
                                        <tr>
                                            <td style="width:55px;padding-top:10px;"><asp:CheckBox ID="chkS5Q11" runat="server" AutoPostBack="True" Text="ไม่มี" /></td>
                                              <td><asp:RadioButtonList ID="optS5Q11" runat="server"
                                                        RepeatDirection="Horizontal" CssClass="table no-border"  AutoPostBack="True">
                                                       <asp:ListItem Value="0">ปรับปรุง</asp:ListItem>
                                                        <asp:ListItem Value="1"> พอใช้</asp:ListItem>
                                                        <asp:ListItem Value="2">ดี</asp:ListItem>
