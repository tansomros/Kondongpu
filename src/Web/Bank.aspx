<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Bank.aspx.vb" Inherits="Kondongpu.Bank" %>
                ...
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        <div class="page-title-icon">
                            <i class="pe-7s-culture icon-gradient bg-primary"></i>
                        </div>
                        <div>ธนาคาร
                            <div class="page-title-subheading">จัดการ เพิ่ม/แก้ไข ธนาคาร </div>
                        </div>
                    </div>
                </div>
            </div> 
...
<section class="content">  
      ...
      <div class="main-card mb-3 card">
        <div class="card-header"><i class="header-icon fa fa-piggy-bank icon-gradient bg-success">
            </i>ธนาคาร
...
<asp:GridView ID="grdData" CssClass="table table-hover"  
              ...
              <itemtemplate>
                    <asp:linkButton ID="imgEdit" runat="server"  Text="แก้ไข" CssClass="btn btn-primary" Width="60"
                                    CommandArgument='<%# DataBinder.Eval(Container.DataItem, "BankID") %>' />  
        ...
        <div class="modal-content">
          <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <h6 class="modal-title">จัดการธนาคาร</h6>
          </div>
