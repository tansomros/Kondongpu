...
namespace Kondongpu.Application.Features.SpecialTests.ViewModel;
public class SpecialTestViewModel : IMapFrom<SpecialTest>
{
    ...
    {
        profile.CreateMap<SpecialTest, SpecialTestViewModel>()
            ...
            .AfterMap((s, d) =>
            {
                ...
                d.ResultDisplayName = code switch
                {
                    ...
                    "BMD" => BmdResult.TryFromValue(s.ResultValue, out var bmd) ? bmd!.DisplayName : null,
                     "UWA" or "UUA" or "ECH" or "MAMO" or "UB" or "EKG" or "EST"
...
public class SpecialTestListViewModel
{
    public ICollection<SpecialTestViewModel> SpecialTests { get; set; }

    public SpecialTestListViewModel()
    {
        SpecialTests = [];
    }
}
