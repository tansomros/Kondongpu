...
public record UpdateCheckupFromWorkerCommand : IRequest<Unit>
{
...
public class UpdateCheckupOvstCommandHandler : IRequestHandler<UpdateCheckupFromWorkerCommand, Unit>
{
    private readonly KondongpuDatabaseContext _context;

    public UpdateCheckupOvstCommandHandler(KondongpuDatabaseContext context)
    {
        _context = context;
    }

    public async Task<Unit> Handle(UpdateCheckupFromWorkerCommand request, CancellationToken cancellationToken)
    {
